...
That gives us the confidence that the output is to the standards that we need it to be, which gives us the confidence to sell a product, which is, we think, at the right level for our customer base_._

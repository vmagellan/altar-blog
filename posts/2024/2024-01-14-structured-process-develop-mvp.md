...
So, let’s say that your first assumption is that users are _really_ facing a problem/pain (for this example let’s call it “Pain X”.)
...
So, keep in mind as you build your list of assumptions, that some have to be tackled _before_ you build your MVP and that direct users aren’t the only stakeholders you should be focusing on.
